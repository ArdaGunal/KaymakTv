export const LandingCSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  ::selection { background: rgba(176, 198, 255, 0.3); }
  ...
  .lang-btn:hover { background: rgba(27, 32, 42, 1); }
  ...
  .btn-primary {
    ...
    box-shadow: 0 4px 16px rgba(176, 198, 255, 0.2);
    transition: transform 0.2s, box-shadow 0.2s;
  }
  .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(176, 198, 255, 0.3); }
  ...
  .hero-glow {
    ...
    width: 100%; height: 400px; pointer-events: none;
    background: radial-gradient(circle at top, rgba(176, 198, 255, 0.08) 0%, transparent 60%);
  }
  ...
  .eyebrow-badge {
    ...
    color: var(--primary); font-size: 12px; font-weight: 700; letter-spacing: 1.4px;
  ...
  .features-head .eyebrow {
    ...
    color: var(--primary); font-size: 11px; font-weight: 700; letter-spacing: 1.4px;
  }
  ...
  .footer-logo .dot { width: 8px; height: 8px; background: rgba(176, 198, 255, 0.6); border-radius: 50%; }
